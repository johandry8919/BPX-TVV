...
function getDataB() {
   gapi.client.sheets.spreadsheets.get({
       ...
       for (var i = 0; i < sheets.length; i++) {
           ...
           if (sheetName === 'bx') {
            let datos;
             if(bateadores1 != '') datos = '!O28:Q31' , parte = 1
              else if(bateadores2 != '') datos = '!K28:M31' , parte = 0
                                    ...
                                    if (result1) {
                                        let {
                                          ...
                                          if(parte == 0){
                                            ...
                                            Id_equipo_visitante.src = logos_equipos[equipo_juega].img_url;
                                          } else {
                                            vatiadores = id_peloteros
                                            Id_equipo_visitante.src = logos_equipos[equipo_juega].img_url;
                                          }
                                      ...
                                      .then(datas => {
                                        ...
                                        document.getElementById('apariciones_right').innerText = S
