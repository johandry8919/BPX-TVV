...
function runTemplateUpdate() {
  ...
  var SPREADSHEET_ID = "1qEDbz16byGUzTdJVH-Fjg-X6yFXGzDBDNyxhoKaX-00";
  var DISCOVERY_DOCS = [
                  ...
                  function (response) {
                    ...
                    if (e("f3")) {
                      if (e("f3").innerText == "none") {
                        ...
                        document.querySelector(".contcenter").style.left =
                          "20%";
                      } else if (e("f3").innerText) {
                        e("logoPatrocinio").src = e("f3").innerText;
                      }
                      if (e("primer_turno")) {
                        e("primer_turno").innerHTML = htmlDecode(
                          e("f4").innerText
                        );
                      }
                    }
                    ...
                    Promise.all([fetchApiData(url1, params)])
                      .then(([result1]) => {
                        ...
                        fetch(url, {
                          ...
                          .then((datas) => {
                            logos_equipos.src =
                              Logos_equipos[id_equipo_jugado].img_url;
                            fondo_equipos.src =
                              Fondo_equipos[id_equipo_jugado].img_url;
                            ...
                            document.getElementById(
                              "fxt"
                            ).innerText = ` ${periodo} ${Temporada}    AVG  ${0} /  CA ${0} /  H ${0} / HR ${0}  / CI ${0} `;
                            datas.data.forEach((element, index) => {
                              ...
                              if (parte == 1) {
                                if (document.getElementById("fxt")) {
                                  document.getElementById(
                                    "fxt"
                                  ).innerText = `${periodo} ${Temporada}     AVG  ${AVE} /  CA ${element.CA} /  H ${element.HIT} / HR ${element.HR}  / CI ${element.CI} `;
                                }
                              } else {
                                if (document.getElementById("fxt")) {
                                  document.getElementById(
